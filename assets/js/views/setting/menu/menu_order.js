    ...
    $.reqData({
        ...
        callback: function (vdata) {
            ...
            $.each(_data, function (k, v) {
                _html += '<a href="#" class="list-group-item" data-key="' + v.key + '">';
                _html += '<h4 class="list-group-item-heading"><i class="' + v.Icon + '" style="min-width:30px;"></i>' + v.Menu + '</h4>';
        ...
        click: function () {
            ...
            $.bConfirm({
                buttonOK: function (k) {
                    k.close();
                    $.reqData({
                        url: mvcPatch('menu/editMenuOrder'),
